...
print("1)", "Today we learn abboud coding")
print("2)", "Today we lean about coding and", name_of_the_game)
print("3)", "Today we lean about coding and", name_of_the_game, "and stuff")

# TODO: Print the content of 'your_name' and 'name_of_the_game' in one line.
# Hint: Use the print command from above and modify it
